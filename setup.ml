...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6e70170607223c7331fff863642f0fa2) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Siddharth Vinothkumar"];
          homepage = None;
          synopsis = "Octal Converter";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\224\244w\226P\234\190I\235\151\200\018,[\196a";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
